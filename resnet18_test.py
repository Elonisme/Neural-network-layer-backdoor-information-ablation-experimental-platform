...
def resnet18_backdoor_information_detect():
    ...
    # 初始化模型、损失函数和优化器
    poison_model, clear_model = get_resnet10_model(device=device)
    values = resnet18_robustness_test(
